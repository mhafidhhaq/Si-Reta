                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li>
                                <a href="index.php"><i class="ti-dashboard"></i><span>Daftar Pekerjaan</span></a>
                            </li>
							<li class="active">
                                <a href="applicant.php"><i class="ti-dashboard"></i><span>Daftar Pelamar</span></a>
                            </li>
							<li>
                                <a href="scheduling.php"><i class="ti-dashboard"></i><span>Jadwal</span></a>
                            </li>
                            <li>
...
<!-- market value area start -->
        ...
        <footer>
            <div class="footer-area">
                <p>By KP ITERA (SPBE Diskominfotik)</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
