        ...
        <div class="wraper">
            ...
            <div style="background-image:url('https://www.eco.ca/wp-content/uploads/Working-home.jpg');background-repeat:no-repeat; width:100%; height:420px;">
                <div class="container-fluid text-center">
                    <div class="slider-text" style="margin-top:7%; margin-left:20%;">
                        <h2 style="color:white; font-family:cambria">DISKOMINFOTIK PROVINSI LAMPUNG</h2>
							...
							<div class="col-md-3 col-sm-6">
								<div class="single-blog mb-30">
									...
									<div class="blog-title">
										...
										<a href="apply.php" type="button" class="btn btn-primary"><font color="white">Daftar</font></a>
									</div>
								</div>
